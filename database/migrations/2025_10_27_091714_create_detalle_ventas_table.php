...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::create('detalle_ventas', function (Blueprint $table) {
            ...
            // Datos del Detalle
            $table->decimal('cantidad', 8, 2); // Acepta decimales para productos por peso
            $table->decimal('precio_unitario', 10, 2)->comment('Precio de venta unitario en el momento de la venta');
            $table->decimal('subtotal', 10, 2)->comment('Cantidad * Precio Unitario (Neto de descuento de línea)');
            ...
            $table->decimal('precio_costo', 10, 2)->comment('Costo del producto al momento de la venta');

            // --- Desglose de Impuestos/Descuentos ---
            $table->decimal('iva_porcentaje', 5, 2)->comment('Tasa de IVA aplicada (Ej: 19)');
